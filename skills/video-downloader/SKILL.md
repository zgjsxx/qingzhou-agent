...
- Requires `yt-dlp` to be installed explicitly before downloading
...
- If `yt-dlp` is missing, install it explicitly with `python -m pip install yt-dlp` before retrying
